library custom_story_editor;

export './src/models/story_custom_text.dart';
...
class CustomStoryEditor extends StatefulWidget {
  ...
  final CustomStoryEditorController controller; // Custom controller for managing editor state.
...
class _CustomStoryEditorState extends State<CustomStoryEditor> {
  ...
  void dispose() {
    ...
    widget.controller.setStoryEditingModeSelected = StoryEditingModes.open;
              ...
              return ValueListenableBuilder(
                ...
                builder: (BuildContext context, StoryEditingModes mode, Widget? child) {
                  return PopScope(
                    ...
                    child: Container(
                      color: widget.isStory == true ? Colors.black : Colors.white,
                      child: Stack(
                        ...
                        children: [
                          ...
                          if (mode == StoryEditingModes.paint)
                            PaintControlsView(
                              doneText: widget.storyCustomText?.doneText,
                          ...
                          // handled within DraggableStickerWidget
                              ...
                              MainControlsView(
                                storyCustomText: widget.storyCustomText,
                                stickerList: stickerListValue,
                                ...
                                onTextClickListener: () {
                                  ...
                                  setState(() {
                                    ...
                                    final draggableText  = DraggableTextWidget(
                                      hintAddText: widget.storyCustomText?.hintAddText,
                                      doneText: widget.storyCustomText?.doneText,
                                      controller: widget.controller,
