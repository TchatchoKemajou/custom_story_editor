...
import 'package:custom_story_editor/src/const/filters.dart';
...
class TopView extends StatefulWidget {
  ...
  final CustomStoryEditorController controller; // Controller for managing editor state.
              ...
              if (!isVideo(widget.selectedFile))
                Row(
                  children: [
                    ...
                    widget.selectedFilters[widget.currentPageIndex] != noFiler
                        || widget.lines.isNotEmpty
                        || widget.textList[widget.currentPageIndex].isNotEmpty
                        || widget.stickerList[widget.currentPageIndex].isNotEmpty
                        ? GestureDetector(
