...
import 'package:custom_story_editor/src/models/story_custom_text.dart';
import 'package:custom_story_editor/src/models/stroke.dart';
import 'package:custom_story_editor/src/utils/utils.dart';
import 'package:custom_story_editor/src/views/main_control_views/filters_view.dart';
import 'package:custom_story_editor/src/widgets/draggable_sticker_widget.dart';
import 'package:custom_story_editor/src/widgets/draggable_text_widget.dart';
...
class MainControlsView extends StatefulWidget {
  ...
  final CustomStoryEditorController controller; // Controller for managing editor states and interactions.
  ...
  final StoryCustomText? storyCustomText;
  ...
  const MainControlsView(
      ...
      required this.isSaving,
        ...
        required this.onStickersClickListener, required this.stickerList, this.storyCustomText,
       });
        ...
        children: [
          ...
          if(widget.isFocused == false)
            isVideo(widget.selectedFiles![widget.currentPageIndex])
              ? Container()
              : FilterTextView(controller: widget.controller, filterText: widget.storyCustomText?.filterText,),
          const SizedBox(
            height: 5,
          ),
          Column(
