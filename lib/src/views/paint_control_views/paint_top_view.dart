...
class PaintTopView extends StatefulWidget {
  ...
  const PaintTopView(
      ...
      required this.onUndoClickListener,
        ...
        this.pencilColor, required this.onDoneClickListener, required this.lines, this.doneText,
});
            ...
            children: [
              GestureDetector(
                ...
                child: Container(
                  ...
                  child: Center(
                    child: Text( widget.doneText ?? "Done", style: TextStyle(fontSize: 15, color: Colors.white),),
                  ),
                ),
              ),
              Row(
