...
import 'package:custom_story_editor/src/views/text_control_views/text_control_view.dart';
import 'package:custom_story_editor/src/widgets/hue_color_picker_slider.dart';

class DraggableTextWidget extends StatefulWidget {
  final List<Widget> textList;
  final CustomStoryEditorController controller;
  final String? hintAddText;
  final String? doneText;
  const DraggableTextWidget({super.key, required this.textList, required this.controller, this.hintAddText, this.doneText});
                    ...
                    child: IntrinsicWidth(
                      child: TextField(
                        ...
                        decoration: InputDecoration(
                            border: InputBorder.none,
                            hintText: widget.hintAddText ?? 'Add text',
